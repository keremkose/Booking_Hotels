...
from app.routers import booking_controller, hotel_controller, hotel_rating_controller, room_controller, user_controller, user_rating_controller,file_controller
